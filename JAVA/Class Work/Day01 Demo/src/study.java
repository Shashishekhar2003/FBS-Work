...
class Transaction {
    ...
    Transaction(int accountNo, double amount, String type, String mode, String status) {
        ...
        this.type = type;
        this.mode = mode;
        this.status = status; // FIXED ERROR
    ...
    public String toString() {
        return "Transaction [accountNo=" + accountNo + ", amount=" + amount + ", type=" + type +
                ", mode=" + mode + ", status=" + status + ", dateTime=" + dateTime + "]";
    }
...
class TransactionManager {
    ...
    void printAll() {
        ...
        else for (Transaction t : list) t.print();
    }
...
abstract class Account {
    ...
    void printTransactions() { tm.printAll(); }
...
class LoanAccount extends Account {
    ...
    void payEmi(double amount) {
        if (amount <= 0) { System.out.println("Invalid EMI"); return; }
        balance += amount;
...
class BankModel {
    ...
    void add(Account a) { accounts.add(a); }

    Account get(int ac) {
        for (Account a : accounts)
            if (a.accountNumber == ac) return a;
        return null;
    }

    Account[] getAll() { return accounts.toArray(new Account[0]); }
}
...
class BankController {
    ...
    Account find(int ac) { return model.get(ac); }
    ...
    void start() {
        while (true) {
            ...
            switch (ch) {
                ...
                case 4: show(); break;
                case 5: c.dailyReport(); break;
                case 6: c.saveReport(); break;
                case 0: return;
